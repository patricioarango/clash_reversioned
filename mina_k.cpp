...
ResultadoComparacionMina compararMina(MINA mina1, MINA mina2) {
    if (mina1.tipo > mina2.tipo) {
        return MAYORMINA;
    }
    else if (mina1.tipo < mina2.tipo) {
        return MENORMINA;
    }
    else {
        return IGUALMINA;
...
void initMina(MINA &mina)
{
    strcpy(mina.imagen,"assets/images/mina.png");
    mina.id_mina = 1;
    mina.posX = 0;
    mina.posY = 0;
    mina.intervalo_produccion = 1;
    mina.tipo = 0;
    mina.secuencia_produccion1 = 1;
    mina.secuencia_produccion2 = 1;
    mina.secuencia_produccion3 = 1;
    mina.secuencia_produccion4 = 1;
    mina.secuencia_produccion5 = 1;
    mina.imgW = 70;
    mina.imgH = 70;
}
//-------------------------------------------------------------------------------------
